...
<div class="col-sm-3" id="select_user">
	...
	echo"
		...
		<img src='users/$user_image' width='90px' height='80px' title='$user_name'> 
		<strong>
			
		&nbsp $first_name $last_name 	
   ...
   <div class="col-sm-6" >
   	...
   	<div class="load_msg"  id="scroll_messages"  >
		...
		global $con;
   		...
   		<div id="loaded_msg" >
   			...
   			<p><?php
   			 if($user_to == $user_to_msg AND $user_from == $user_from_msg) {echo "<div class='message' id='blue'  data-toggle = 'tooltip'  title='$msg_date'>$msg_body </div><br><br><br>";} else if($user_from == $user_to_msg AND $user_to == $user_from_msg)
   				{ 
   	...
   	if(isset($_POST['send_msg'])){
   		...
   		$run_insett = mysqli_query($con, $insert);
}
   }
   	?>
