		...
		while ($row_posts = mysqli_fetch_array($run_posts)) {
			...
			if ($content == "no" && strlen($upload_image) >= 1) {
				...
				<div class= 'col-sm-4' >
					...
					<a href ='funtions/delete_post.php?post_id =  $post_id' style = 'float:right;'><button class='btn btn-danger'>Delete</button></a><br>	
				...
				<div class= 'col-sm-4' >
					...
					<a href ='funtions/delete_post.php?post_id =  $post_id' style = 'float:right;'><button
				...
				if($u_email !=  $user_email){
					...
					echo "<scrip> window.open('profile.php?u_id = $user_id', '_self' ) </scrip> ";
				}else{
