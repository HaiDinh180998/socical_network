...
$con = new mysqli("localhost","root","","socical_network") or die("Connection was not established");
	...
	function search_user(){
		...
		while ( $row_user = mysqli_fetch_array($run_user)) {
			...
			<div class='row'>
				...
				<div class='col-sm-6'>
				<a style='text-decoration:none;cursor:pointer;color:#3897f0; 'href='user_frofile.php?u_id=user_id'>
