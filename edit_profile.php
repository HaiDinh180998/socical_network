	...
	<div class="col-sm-8" >
		<form action=""  method="post"  enctype="multipart/form-data" >
			<table class="table table-bordered table-hover">
				...
				<tr>
					<td style="font-size: bold;">Change Your Firstname</td>
					<td>
				...
				<tr>
					<td style="font-size: bold;">Relationship Status </td>
					<td>
				...
				<tr>
					<td style="font-size: bold;">Password</td>
					<td>
				...
				<tr>
					<td style="font-size: bold;">Gender</td>
					<td>
				...
				<tr>
					<td style="font-size: bold;">Birthdate </td>
					<td>
